...
BOT_TOKEN = environ.get('BOT_TOKEN', "7522340272:AAFShVQwnq1E9vIHut0O3aYXnCltHnL0iBY")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002171798415')) #Log channel id ( make sure bot is admin )
